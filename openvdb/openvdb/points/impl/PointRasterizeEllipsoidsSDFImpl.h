...
/// @brief  Use superior ellipse norm projections rather than simply inverse
///   transforming to unit spheres. Only exists as a dev option to compare
///   the results.
...
#if OPENVDB_ELLIPSOID_PROJECT_ONTO_SURFACE == 0
...
#if OPENVDB_ELLIPSOID_PROJECT_ONTO_SURFACE == 1
